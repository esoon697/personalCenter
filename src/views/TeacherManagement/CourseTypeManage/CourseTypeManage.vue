    ...
    <div slot="main-content" class="view-outer">
      ...
      <div class="search-group">
        ...
        <div class="search-item">
          ...
          <el-input class="input-style" id="item2" v-model="period" size="mini" placeholder="请输入内容"></el-input>
        </div>
        <div class="search-item">
          <label for="item3">类别学分：</label>
          <el-input class="input-style" id="item3" v-model="credit" size="mini" placeholder="请输入内容"></el-input>
        </div>
        <div class="search-item">
          <label for="item4">状态：</label>
          <el-select style="width: 140px" class="select-style" id="item4" v-model="state" size="mini" placeholder="请选择">
            <el-option
      ...
      v-if="isShowAdd">
        <div class="add-box" slot="dialog-content">
          <el-form :model="addForm" :rules="rules" ref="addForm" label-position="right" label-width="130px" class="demo-addForm">
            ...
            <el-row :gutter="20">
              <el-col :span="14">
                <el-form-item label="类别学分" prop="period">
            ...
            <el-row :gutter="20">
              <el-col :span="14">
                <el-form-item label="类别学时" prop="credit">
